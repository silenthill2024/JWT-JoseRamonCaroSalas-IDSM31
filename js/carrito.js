...
if (tokenOAuth) {
    ...
    // Recibir JWT generado por el servidor después de Google OAuth
    token = tokenOAuth;

    // Guardar el JWT para utilizarlo en las peticiones protegidas
    localStorage.setItem('token', tokenOAuth);

    // Limpiar el JWT de la barra de direcciones
